...
function gotoVideo(){
	...
	let title = $('#main_title_label').text();
  parentref.postMessage({ event_id: 'handleClick', data: { type: 'video', title: title, hash: '', language: language } }, '*' );
...
function gotoImages(){
	...
	let title = $('#main_title_label').text();
  parentref.postMessage({ event_id: 'handleClick', data: { type: 'images', title: title, hash: '', language: language } }, '*' );
...
function gotoBooks(){
	...
	let title = $('#main_title_label').text();
  const url = encodeURI( 'https://conze.pt/app/openlibrary/?l=en&mode=title&title=' + encodeURIComponent( title ) );
  window.top.postMessage({ event_id: 'handleClick', data: { type: 'link-split', url: url, title: title, hash: '', language: language } }, '*' );
...
function gotoWikidata(){
	...
	let title = $('#main_title_label').text();
  const url = encodeURI( 'https://wikidata.org/wiki/' + qid );
  parentref.postMessage({ event_id: 'handleClick', data: { type: 'link', url: url, title: title, hash: '', language: language } }, '*' );
